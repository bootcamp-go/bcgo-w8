...
CREATE TABLE IF NOT EXISTS employee (
    ...
    CONSTRAINT `fk_employee_depto_nro` FOREIGN KEY (`depto_nro`) REFERENCES `departamento` (`depto_nro`)
);
...
INSERT INTO employee (`cod_emp`, `nombre`, `apellido`, `puesto`, `fecha_alta`, `salario`, `comision`, `depto_nro`) VALUES
